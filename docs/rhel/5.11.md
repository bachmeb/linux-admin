...
* Capacity: 7.21 GB
* File system: exFAT
* Allocation unit size: 32768 kilobytes <-- this value should be as large as possible, considering that the only contents of the disk will be a 4.4 GB ISO file
* Format options: Quick Format
* Volume label: ISO
